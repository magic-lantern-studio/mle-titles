...
MlBoolean initEnv(int argc,void **argv)
{
	...
	new DxStage();
    ((DxStage *)MleStage::g_theStage)->m_showMode = nCmdShow;
    ((DxStage *)MleStage::g_theStage)->init();
...
initPlatform(HINSTANCE hInstance)
{
    ...
    win32Data->m_keyboardManager = MLE_INPUT_DEVICE_MANAGER_NOT_INSTANTIATED;
    win32Data->m_mouseManager = MLE_INPUT_DEVICE_MANAGER_NOT_INSTANTIATED;
    win32Data->m_joystickManager = MLE_INPUT_DEVICE_MANAGER_NOT_INSTANTIATED;
